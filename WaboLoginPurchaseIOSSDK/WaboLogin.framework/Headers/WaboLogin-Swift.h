...
#ifndef WABOLOGIN_SWIFT_H
#define WABOLOGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WaboLogin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9WaboLogin9WaboLogin")
@interface WaboLogin : NSObject
+ (WaboLogin * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
/// is init complete
///
/// returns:
/// is init complete
...
SWIFT_CLASS("_TtC9WaboLogin13WaboLoginType")

...
#ifndef WABOIAP_SWIFT_H
#define WABOIAP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WaboIap",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7WaboIap7WaboIap")
@interface WaboIap : NSObject <SKPaymentTransactionObserver, SKProductsRequestDelegate>
+ (WaboIap * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
/// is init complete
///
/// returns:
/// is init complete
